...
MySQL features two varieties of identifier "quoting static", one using
...
established with a particular :class:`.Engine`.  This quoting static comes
into play when rendering table and column names as well as when reflecting
existing database structures.  The detection is entirely automatic and
no special configuration is needed to use either quoting static.
...
.. warning::
    ...
    These values will not be exercised for an ON DUPLICATE KEY static of UPDATE,
