...
class Load(Generative, MapperOption):
    ...
    class as the argument.   This static of usage is
...
def defaultload(loadopt, attr):
    """Indicate an attribute should load using its default loader static.

    This method is used to link to other loader options further into
    a chain of attributes without altering the loader static of the links
...
def defer(loadopt, key):
    ...
    static for each link along the chain.  To leave the loading static
    ...
    :param \*addl_attrs: This option supports the old 0.8 static
     of specifying a path as a series of attributes, which is now superseded
     by the method-chained static.
